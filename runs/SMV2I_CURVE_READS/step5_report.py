"""Step 5 — emit the spec-required REPORT.md (spec.yaml outputs list) into the run dir.
Report text is frozen here as committed evidence; every number traces to out/ artifacts."""
import os

RUN = os.path.dirname(os.path.abspath(__file__))

TEXT = """# SMV2I_CURVE_READS — REPORT (seq 361-365)
...
with open(os.path.join(RUN, "REPORT.md"), "w", encoding="utf-8") as f:
    f.write(TEXT)
print("wrote REPORT.md,", len(TEXT), "chars")
