...
OUT = "runs/SM03_DISASTER_STOP/out"
...
ARMS = [
    (291, "mid_only_1.0",  {"mid": 1.0}),
    (292, "mid_only_1.25", {"mid": 1.25}),
    (293, "mid_slow_1.0",  {"mid": 1.0, "slow": 1.0}),
    (294, "mid_slow_1.25", {"mid": 1.25, "slow": 1.25}),
    (295, "tiered",        {"fast": 1.5, "mid": 1.0, "slow": 1.25}),
    (296, "all_1.5",       {"fast": 1.5, "mid": 1.5, "slow": 1.5}),
]
