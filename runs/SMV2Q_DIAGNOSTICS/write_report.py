"""Emit the spec-required REPORT.md for SMV2Q_DIAGNOSTICS (all numbers from out/ artifacts)."""
import os

REPO = r"D:\OneDrive - Washington University in St. Louis\TradingResearch\systematic_research"
CONTENT = """# SMV2Q_DIAGNOSTICS — REPORT (seq 380)
...
path = os.path.join(REPO, "runs", "SMV2Q_DIAGNOSTICS", "REPORT.md")
