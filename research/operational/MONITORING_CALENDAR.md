...
| **~2026-09-10 (before Sept expiry 09-18)** | ⚠️ **CONTRACT ROLL — redeploy both paper legs on NQ 12-26** | `WeeklyEdgeP1PCT_v1` + `WeeklyEdgeXMConflict_v2` on DEMO8383477 | `PAPER_DEPLOYMENT_20260830.md` | XM's `EsInstrument`/`RtyInstrument`/`YmInstrument` must be set to **ES/RTY/YM 12-26** at redeploy (they default to 09-26). Flatten before swapping; record the swap in the deployment file. |
