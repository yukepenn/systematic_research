...
| **`XM_CONFLICT_v2`** | 🔴 **LIVE-ENABLED 2026-09-01** (as `WeeklyEdgeXMConflictMnq_v1` `399562886`, the MX01 MNQ port at 0.30 scale, account `2047681`) · **PARITY-CERTIFIED** · ⚠️ **`SHADOW-VALIDATED` was SKIPPED, exactly as for P1** — corrected 2026-09-01, this row previously read "not live" while its own book-mate one row above read LIVE-ENABLED | **REGIME-LOCAL by data availability** | ES/RTY/YM substrates **begin 2022-01-02**, so no 2006–2021 test exists *or can be built*. Strong modern evidence + coherent mechanism ≠ structural evidence. N = 348, discovery-consumed |
