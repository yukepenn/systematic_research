...
| **BBO microstructure** | **DATA-CAPABLE** | **DISCOVERY-GRADE ONLY** | no clean BBO historical holdout exists — every quote-complete session has had its outcomes consumed. Any result awaits **prospective** confirmation |
...
| **TSMOM V2 (252d slow trend)** | **AUTHORIZED — ONE SHOT** | ⚠️ **DEVELOPMENT-DERIVED / ONE-OF-FOUR SELECTION — NOT clean development evidence** | selected after inspecting V1's four predeclared components; it was not invented after the fact, but its development Sharpe 0.479 is **discovery, not evidence**. The **untouched 2019–2022 validation is how the selection debt is paid** · `runs/TSMOM_V2_SLOWTREND_20260827/` |
