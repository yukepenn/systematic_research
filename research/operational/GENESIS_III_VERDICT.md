...
| spread + slippage | ≈ **$282** | ⚠️ **CORRECTED**: EXEC01's `$20.65/ctrRT` is **SPREAD ONLY**, not all-in — true all-in is **$25.01** ($20.65 spread + $4.36 commission). The original row subtracted commission out of $20.65 and then charged it again in the row below, double-discounting. $20.65 × 3,317 ctrRT ÷ 243 wk = **$282**, not $222. Net effect on the DECOMPOSITION: the spread row was understated by ≈ **$59/wk**. ⚠️ **THAT IMPACT CLAIM IS ITSELF WITHDRAWN 2026-09-01: the mislabelled spread row ($222.36) and the double-counted commission row ($59.51) CANCELLED TO THE CENT** — `2211 − 222.36 − 59.51 = $1929.12` and `2211 − 281.88 = $1929.12`. The label and the decomposition were wrong; **the published bottom line never moved.** See `COST_MODEL.md` §4. |
...
| expected cost | ⚠️ **$25.01/ctrRT all-in on NQ** = $20.65 measured **spread** (median $20.00, p90 $35.00) **+ $4.36 commission**. The earlier "$20.65 all-in" label was wrong. ⚠️ **THAT IMPACT CLAIM IS ITSELF WITHDRAWN 2026-09-01: the mislabelled spread row ($222.36) and the double-counted commission row ($59.51) CANCELLED TO THE CENT** — `2211 − 222.36 − 59.51 = $1929.12` and `2211 − 281.88 = $1929.12`. The label and the decomposition were wrong; **the published bottom line never moved.** See `COST_MODEL.md` §4. **MNQ (the live execution instrument): $1.30/ctr RT commission MEASURED (n=704); 🔴 SPREAD NOT MEASURED.** The "spread does not degrade" premise has correct tick arithmetic and an unverified empirical half, and the ≈$35/wk figure is the COMMISSION penalty ALONE — band −$5.6 to +$76.3/wk. Corrected 2026-09-01; authority `research/operational/COST_MODEL.md` §5 |
