// =====================================================================================
// WeeklyEdgeP1PCTMnq_v2  -  MNQ EXECUTION PORT of WeeklyEdgeP1PCT_v3.
//
...
{
    public class WeeklyEdgeP1PCTMnq_v2 : Strategy
    {
        ...
        private bool HdAccountSignedQty(out int q)
        {
            ...
            try
            {
                NinjaTrader.Cbi.Position pa = PositionsAccount[EXEC];
        ...
        { try { return Instruments[EXEC].FullName; } catch (Exception) { return "?"; } }
        ...
        protected override void OnBarUpdate()
        {
            ...
            AcctWitness(myQty * MnqPerNq);          // [HD-23] the FOURTH witness: the ACCOUNT
