// =====================================================================================
// WeeklyEdgeXMConflictMnq_v2  -  MNQ EXECUTION PORT of WeeklyEdgeXMConflict_v4.
//
...
{
    public class WeeklyEdgeXMConflictMnq_v2 : Strategy
    {
        ...
        private bool HdAccountSignedQty(out int q)
        {
            ...
            try
            {
                NinjaTrader.Cbi.Position pa = PositionsAccount[MNQ];
        ...
        { try { return Instruments[MNQ].FullName; } catch (Exception) { return "?"; } }
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Name                      = "WeeklyEdgeXMConflictMnq_v2";
        ...
        protected override void OnBarUpdate()
        {
            ...
            AcctWitness(myPos * Qty * MnqPerNq);          // [HD-23] the FOURTH witness: the ACCOUNT
