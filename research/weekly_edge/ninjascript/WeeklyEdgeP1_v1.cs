...
// =====================================================================================
//  WeeklyEdgeP1_v1  -  campaign #7 WEEKLY_EDGE, the P1 object, transcribed from the Python.
//
...
{
    public class WeeklyEdgeP1_v1 : Strategy
    {
            ...
            else if (State == State.DataLoaded)
            {
                ...
                if (!string.IsNullOrEmpty(ExportDir))
                {
                    try
                    {
                        ...
                        export.WriteLine("pyts,close,nMem,nThr,dL,ratio,voteOK,size,score,qty,sessPnl,stopped");
                    }
        ...
        protected override void OnBarUpdate()
        {
            ...
            DateTime pyTs = Time[0].AddMinutes(-1);
        ...
        private void CacheLagged()
        {
            ...
            todKeys.Add(Time[0].AddMinutes(-1).Hour * 60 + Time[0].AddMinutes(-1).Minute);
