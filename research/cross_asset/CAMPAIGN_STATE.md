...
| **Wave 5** | **ZBMACRO01 FAST TRACK** (FT0+FT1+FT4 offline NinjaScript — NO NT8 copy while the live book runs; compile/parity at the 09-21 window) · falsifiers: post-FOMC bond drift · close-hour hedging-flow · duration-extension day | 🟡 preparing |
