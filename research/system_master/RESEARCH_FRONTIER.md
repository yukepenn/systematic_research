...
| R2 (entry timing/pullback) | Conditional entry confirmation (persistence, pullback-then-reclaim) improves entry quality without suppressing rare right-tail entries | **VALIDATING** | confirm_bars=2 entry-confirmation overlay (`SolarWaveOneContractNQ_v6_R2CONFIRM.cs`) | `runs/R2_ENTRY_TIMING/REPORT.md`, `NT8_VALIDATION.md` | Every primary metric improves on both NQ/MNQ simultaneously (net +8.6%/+9.4%, Sharpe +11.2%/+12.0%, CDaR95 better); tail-dollar-positive (+$32,850, opposite of R1); survives 2-tick stress; doesn't miss 2025-04-09; independently adversarially audited, no bug found; early NT8 spot-check PASSED (149/149 exact trade-count match, -2.2% net residual, 2024-04..2025-04 warmed-up window) | Full multi-year chunked NT8 certification, MNQ-side NT8 check, leg-by-leg proof, formal LOYO, proper child spec |
