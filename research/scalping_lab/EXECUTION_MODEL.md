...
- Latency: decision-to-fill delay grid {0, next-event, 250ms, 500ms, 1s, 2s, 5s}, truncated
  to the data's real timestamp fidelity (to be established by the data audit).
