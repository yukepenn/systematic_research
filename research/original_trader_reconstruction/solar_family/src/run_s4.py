"""OTR_S4_EXITS: strict-cross vs touch exit on the S3B finalist shapes."""
import csv
import json
import os
import sys
...
OUT = os.path.join(ROOT, "runs", "OTR_S4_EXITS", "out")
...
WINDOWS = {"W_0200_1600": win(120, 960), "W_0300_1600": win(180, 960), "W_0400_1600": win(240, 960)}
SHAPES = {
...
def main():
    ...
    print("[S4] best:", results[0]["cell"], "D=", results[0]["D"], flush=True)
