...
| **1** | **What replaces TSMOM V1** | ⚠️ **OWNER-FACING CHOICE, not a tuning exercise.** The 252-day component alone would pass every gate (net $25,757, Sharpe 0.479) — **it is deliberately NOT selected**; a post-hoc one-of-four pick is worth ~20 % of MAR on structureless data by this repo's own measurement. A V2 needs its own preregistration, its own multiplicity accounting, and an honest note that the idea came from the failed run |
