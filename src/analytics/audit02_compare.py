...
PAIRS = [
    dict(
        ...
        rerun=os.path.join(ROOT, "runs", "AUDIT02_V3_SWEEP", "ledgers",
                           "a2v3__tf3_sm179_am0_th1_vp460_vm{vm}_xm0_sc_slip1.csv"),
    ...
    dict(
        ...
        rerun=os.path.join(ROOT, "runs", "AUDIT02_V4_SWEEP", "ledgers",
                           "a2v4__NQ_tf3_sm179_am0_th1_vp460_vm{vm}_bp20_xm0_sc_slip1.csv"),
