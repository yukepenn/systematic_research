// SolarWaveOneContractMNQ_Canonical_v1 — EQV04 research-only executable twin of
// SolarWaveOneContractMNQ_v5.
//
// Per research/system_master/CANONICAL_MATHEMATICAL_SPEC.md (derived from EQV01's exhaustive
// finite-state proof, 729/729 states, EXACT_EQUIVALENCE -- same proof as the NQ sibling, since
// both objects share one decision core): the incumbent's continuous
...
// CHANGE. Every other line (cross-series arrangement, ops rules, BMOM computation, session
// handling, order submission, execution watchdog, instrument guard) is byte-identical to the
// incumbent, kept that way deliberately so this file's sole purpose -- proving executable
// parity between the real and canonical representations -- has the smallest possible diff
// surface to audit. The incumbent SolarWaveOneContractMNQ_v5.cs remains the sole source of
// truth for live/backtest behavior; this object is ENGINEERING_ONLY / EQV04, not a promotion,
// not a parameter change, and not intended for standalone use.
//
// ==========================================================================================
...
{
    public class SolarWaveOneContractMNQ_Canonical_v1 : Strategy
    {
        private const string BuildTag = "SolarWaveOneContractMNQ_Canonical_v1 2026-08-10";
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name = "SolarWaveOneContractMNQ_Canonical_v1";
                ...
                ExportDir = ""; Tag = "mnq_canonical_v1";
            }
