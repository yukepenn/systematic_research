// SolarWaveOneContractNQ_B1_v1 — frozen SIMPLE01 "B1" rung, executable research object.
//
...
// session-close and entry-block rules are all UNCHANGED from the incumbent. This is the ONE-LINE
// diff below and nothing else — no other decision-logic line in this file differs from
// SolarWaveOneContractNQ_v5.cs. Per master directive sec17-25: this candidate is FROZEN, not
// retuned; its scientific value comes from being identified by PLACEBO01's HTF-placebo-weakness
// finding plus SIMPLE01's blind near-miss result, and that value is destroyed by tuning. This
// object is an IMPLEMENTATION-PARITY twin only — it reproduces SIMPLE01's Python B1 candidate
// exactly, it does NOT re-adjudicate B1's historical verdict (SIMPLE01 already found B1 blocked
// on one inconclusive Sharpe read after the completion pass; that verdict stands unchanged).
// Any future promotion decision requires NEW evidence (locked-forward or protected pool), never
// further analysis of this already-consumed history alone (sec25).
//
// ==========================================================================================
...
{
    public class SolarWaveOneContractNQ_B1_v1 : Strategy
    {
        private const string BuildTag = "SolarWaveOneContractNQ_B1_v1 2026-08-10";
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name = "SolarWaveOneContractNQ_B1_v1";
