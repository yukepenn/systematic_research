// SolarWaveSMMaster_v2 — DAYONLY_DUAL6040 consolidated master (SMV2M, seq 371).
//
...
{
    public class SolarWaveSMMaster_v2 : Strategy
    {
        ...
        private void OpenBarLog()
        {
            try
            {
                ...
                barLog.WriteLine(string.Format(CultureInfo.InvariantCulture,
                    "# SolarWaveSMMaster_v2 KS={0} KB={1} tilt={2}/{3}/{4} short={5} band={6}",
            ...
            {
                Print("SolarWaveSMMaster_v2 bar log open failed: " + ex.Message);
        ...
        private void Flush()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(ExportDir) && fillLog != null)
                {
                    ...
                    {
                        w.WriteLine("# SolarWaveSMMaster_v2 execs=" + execCount);
            ...
            {
                Print("SolarWaveSMMaster_v2 export failed: " + ex.Message);
            }
        }
