...
// OriginalTraderSolarCAND2_v2 — NinjaScript port of OTR-S-CAND2 (directive v3.0 §7),
...
{
    public class OriginalTraderSolarCAND2_v2 : Strategy
    {
        // Solar core state
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Name        = "OriginalTraderSolarCAND2_v2";
            ...
            {
                Log("OriginalTraderSolarCAND2_v2 is research-only; disabling.", LogLevel.Error);
