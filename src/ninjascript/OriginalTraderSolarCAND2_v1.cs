...
// OriginalTraderSolarCAND2_v1 — NinjaScript port of OTR-S-CAND2 (directive v3.0 §7),
...
//   T1  stop-and-reverse chains; inclusive Close-vs-end-of-bar-TrailingStop exit
...
{
    public class OriginalTraderSolarCAND2_v1 : Strategy
    {
        // Solar core state
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Name        = "OriginalTraderSolarCAND2_v1";
            ...
            else if (State == State.DataLoaded)
            {
                ...
                tradesThisSession = 0; lastExitBar = int.MinValue;
            ...
            {
                Log("OriginalTraderSolarCAND2_v1 is research-only; disabling.", LogLevel.Error);
