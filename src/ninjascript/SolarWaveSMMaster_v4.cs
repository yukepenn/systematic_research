...
{
    public class SolarWaveSMMaster_v4 : Strategy
    {
        ...
        private void OpenBarLog()
        {
            try
            {
                ...
                barLog.WriteLine(string.Format(CultureInfo.InvariantCulture,
                    "# SolarWaveSMMaster_v4 KS={0} KB={1} tilt={2}/{3}/{4} short={5} band={6}",
            ...
            {
                Print("SolarWaveSMMaster_v4 bar log open failed: " + ex.Message);
        ...
        private void Flush()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(ExportDir) && fillLog != null)
                {
                    ...
                    {
                        w.WriteLine("# SolarWaveSMMaster_v4 execs=" + execCount);
            ...
            {
                Print("SolarWaveSMMaster_v4 export failed: " + ex.Message);
            }
        }
